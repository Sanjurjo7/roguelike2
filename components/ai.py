    ...
    def get_path_to(self, dest_x: int, dest_y: int) -> List[Tuple[int, int]]:
        ...
        for entity in self.entity.gamemap.entities:
            ...
            if entity.blocks_movement and cost[entity.x, entity.y]:
                ...
                # other in hallways. A higher number means enemies will
                # take longer paths in order to surround the player.
                cost[entity.x, entity.y] += 10

        # Crete a graph from the cost array and pass that graph to a new pathfinder.
...
class ConfusedEnemy(BaseAI):
    ...
    def perform(self) -> None:
        ...
        if self.turns_remaining <= 0:
            ...
            # direction. It is possible the actor will just bump into a wall,
            # wasting their turn.
